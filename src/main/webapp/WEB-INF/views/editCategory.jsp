...
<div>
<form:form   modelAttribute="category" action="/spring/updateCategory" method="post">
 <table class="table table-stripped table-responsive table-hover">
 <tr>
 <td><form:label path="categorytId"  >Category Id:</form:label></td>
 <td><form:input path="categorytId" value="${category.categoryId}" readonly="true" /></td>
 <td><form:errors path="categorytId" cssClass="error" /></td>
 </tr>
